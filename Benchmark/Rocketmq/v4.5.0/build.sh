...
function build_from_source {
	cFile=inject.c
	exeFile=inject
	srcName=rocketmq-4.5.0-src
	system=rocketmq-4.5.0
	buildJar1=rocketmq-client-4.5.0.jar
	buildJar2=rocketmq-common-4.5.0.jar
	libJar1=rocketmq-client-4.5.0-SNAPSHOT.jar
	libJar2=rocketmq-common-4.5.0-SNAPSHOT.jar
	tar=rocketmq-4.5.0.tar.gz
...
function overwrite_tar {
	tar1="rocketmq-4.5.0.tar.gz"
	tar2="rocketmq-4.7.0.tar.gz"
