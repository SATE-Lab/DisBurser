...
function build_from_source {
	cFile=inject.c
	exeFile=inject
	srcName=apache-cassandra-3.11.2-src
	system=apache-cassandra-3.11.2
	buildJar=apache-cassandra-3.11.2-SNAPSHOT.jar
	libJar=apache-cassandra-3.11.2.jar
	tar=apache-cassandra-3.11.2.tar.gz
...
function overwrite_tar {
	tar1="apache-cassandra-3.11.2.tar.gz"
	tar2="apache-cassandra-3.11.3.tar.gz"
