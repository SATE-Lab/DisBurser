...
function build_from_source {
	cFile=inject.c
	exeFile=inject
	srcName=kafka-3.3.1-src
	system=kafka_2.13-3.3.1
	tgz=kafka_2.13-3.3.1.tgz
	tar=kafka_2.13-3.3.1.tar.gz
...
function overwrite_tar {
	tar1="kafka_2.13-3.3.1.tar.gz"
	tar2="kafka_2.13-3.3.2.tar.gz"
